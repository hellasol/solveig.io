...
const Project = (props) => {
  return (
    <div>
      ...
      <Button
        href="https://thirstycactus-frontend.herokuapp.com"
        color="dark"
      ...
      <br></br>
      <li>
        A decentralized app based on solidity smart contracts, web3.js, Ethereum
        and React.js{" "}
      </li>
      <li>
        Get a free decentralight coin from the faucet and use it to control the
        light
      </li>
      <li>Will eventually be connected to a real light bulb!</li>
      <Button
        href="https://decentralight.solveig.io"
        color="dark"
        className="submitButton"
      >
        Check it out!
